...
/**
 * PemasukanJenisSearch represents the model behind the search form about `app\models\PemasukanJenis`.
 */
class PemasukanJenisSearch extends PemasukanJenis
{
    /**
     * @inheritdoc
     */
