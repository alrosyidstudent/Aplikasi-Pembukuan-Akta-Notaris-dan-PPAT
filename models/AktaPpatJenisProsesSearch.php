...
/**
 * AktaPpatJenisProsesSearch represents the model behind the search form about `app\models\AktaPpatJenisProses`.
 */
class AktaPpatJenisProsesSearch extends AktaPpatJenisProses
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'notaris_id', 'jangka_waktu', 'akta_ppat_jenis_id'], 'integer'],
    ...
    {
        $query = AktaPpatJenisProses::find();
