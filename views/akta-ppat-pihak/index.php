...
/* @var $searchModel app\models\AktaPpatPihakSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Pihak dalam Akta PPAT';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="akta-ppat-pihak-index">
        ...
        ['class' => 'yii\grid\ActionColumn',
            ...
            'buttons' => [
                'detil' => function ($url, $model, $key) {
                    return Html::a('<span class="fa fa-eye" aria-hidden="true"></span> ', ['akta-ppat/view', 'id' => $model->akta_ppat_id]);
                },
