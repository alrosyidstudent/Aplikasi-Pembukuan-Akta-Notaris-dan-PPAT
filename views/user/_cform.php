...
<div class="user-form col-sm-10">
    ...
    echo $form->field($model, 'alamat')->textInput();
    echo $form->field($model, 'notaris_id')->hiddenInput(['value' => Yii::$app->user->identity->notaris_id])->label(false);
    echo $form->field($model, 'role')->hiddenInput(['value' => 'cclient'])->label(false);
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? 'Simpan' : 'Perbaharui', ['class' => $model->isNewRecord ? 'btn btn-warning' : 'btn btn-primary']) ?>
    </div>
